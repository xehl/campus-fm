...
const palettes = [
  ...
  },
  {
    ...
    palette: ["#33251e", "#fac205", "#f9f9f8", "#948c94"],
  },
  {
    sign: "WCBN",
  ...
  },
  {
    ...
    palette: ["#cb142c", "#241c23", "#8c1429", "#a7142c"],
  },
  {
    sign: "WVUD",
...
stations.forEach((station) => {
  let palObj = palettes.find((palette) => station.call_sign === palette.sign);
  station["palette"] = palObj.palette;
});

var fs = require("fs");

fs.writeFile("stationspalettes.js", JSON.stringify(stations), (err) => {
