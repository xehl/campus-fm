...
export default function NowPlaying({ playing }) {
  ...
  return (
    <Box sx={{ width: { xs: "100%", md: 580, xl: 660}, mt: 2}} >
      ...
      <Paper id="mobile-load-button" onClick={fetchOnMobile} elevation={3} sx={{ display: { xs: "flex", md: "none" }, width: "77vw", mb: 3, mt: -2.5, alignItems: "center", justifyContent: "center", borderRadius: '12px', height: { xs: 80, xl: 120 } }}>
        <Typography fontFamily={"Share Tech Mono"} fontSize={"1.2rem"}>Tap to load stations</Typography>
      </Paper>
      <Paper id="mobile-now-playing" elevation={3} sx={{ display: "none", width:"77vw", mb: 3, mt: -2.5, alignItems: "center", justifyContent: "flex-start", borderRadius: '12px', height: { xs: 80, xl: 120 } }}>
